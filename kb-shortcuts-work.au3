...
Func out_task_ticket()
	...
	Local $sgCode = "Note: In my local rig, item SG100003995 already has the correct SGCode value in DB. With this item, I'm able to make edits in item maintenance and save without issue (e.g. save prevented due to incorrect SGCode)."
